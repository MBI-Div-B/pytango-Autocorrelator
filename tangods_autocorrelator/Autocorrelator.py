...
class Autocorrelator(Device):
    ...
    center2 = attribute(
        label="peak 2, with the quartz (loc. max in pixels)",
        dtype="float",
        access=AttrWriteType.READ_WRITE,
        memorized=True,
        hw_memorized=True,
    ...
    xpos = attribute(
        label="start integrating x (pixel)",
        dtype="float",
        access=AttrWriteType.READ_WRITE,
        memorized=True,
        hw_memorized=True,
    ...
    xwin = attribute(
        label="integration window x (pixel)",
        dtype="float",
        access=AttrWriteType.READ_WRITE,
        memorized=True,
        hw_memorized=True,
    ...
    gaussian_pulsewidth_x = attribute(
        name="gaussian_pulsewidth_x",
    ...
    sech2_pulsewidth_x = attribute(
        name="sech2_pulsewidth_x",
    ...
    def read_data_x(self):
        ...
        self.x_axis = np.mean(
            real_data[int(self.__xposi) : int(self.__xposi) + int(self.__xwind), :],
            axis=0,
        )
